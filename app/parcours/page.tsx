  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-orange-50/30">
        ...
        <section className="relative py-16 overflow-hidden">
          ...
          <div className="container mx-auto px-8 lg:px-16 relative z-10">
            <div className="text-center mb-12 animate-fade-in-up">
              <Badge className="mb-4 bg-gradient-to-r from-cpu-orange to-orange-600 text-white border-0 shadow-lg px-4 py-2 text-sm">
                <Sparkles className="w-4 h-4 mr-2" />
                {parcoursMock.length} Parcours disponibles
              </Badge>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4 bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-5xl mx-auto mb-12">
              ...
              <Card className="relative overflow-hidden p-6 text-center border-2 border-slate-100 hover:border-blue-500 shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer group animate-fade-in-up animation-delay-200">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-500/5 mb-3 group-hover:scale-110 transition-transform duration-300">
                    <Users className="w-7 h-7 text-blue-600" />
                  </div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
              ...
              <Card className="relative overflow-hidden p-6 text-center border-2 border-slate-100 hover:border-green-500 shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer group animate-fade-in-up animation-delay-300">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-green-500/10 to-green-500/5 mb-3 group-hover:scale-110 transition-transform duration-300">
                    <Trophy className="w-7 h-7 text-green-600" />
                  </div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
              ...
              <Card className="relative overflow-hidden p-6 text-center border-2 border-slate-100 hover:border-purple-500 shadow-md hover:shadow-2xl transition-all duration-300 cursor-pointer group animate-fade-in-up animation-delay-400">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500/10 to-purple-500/5 mb-3 group-hover:scale-110 transition-transform duration-300">
                    <TrendingUp className="w-7 h-7 text-purple-600" />
                  </div>
                  <div className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-purple-500 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">
                    {Math.round(parcoursMock.reduce((acc, p) => acc + (p.tauxCompletion || 0), 0) / parcoursMock.length)}%
                  </div>
        ...
        <section className="py-8 bg-white/80 backdrop-blur-sm sticky top-0 z-30 border-b border-slate-200 shadow-sm animate-fade-in-up animation-delay-300">
          ...
          <div className="container mx-auto px-8 lg:px-16 text-center relative z-10">
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-cpu-orange to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-10 py-7 text-lg font-bold shadow-2xl hover:shadow-3xl hover:scale-105 transition-all duration-200 shine-effect border-0"
                >
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="bg-white/10 hover:bg-white/20 text-white border-2 border-white/30 hover:border-white/50 backdrop-blur-sm px-10 py-7 text-lg font-bold hover:scale-105 transition-all duration-200"
                >
